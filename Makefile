...
tagpush26:
	docker tag wulffern/aicex:26.04_latest wulffern/aicex:26.04_${TAG}
	docker push wulffern/aicex:26.04_latest
	docker push wulffern/aicex:26.04_${TAG}
...
sh24:
	docker run --rm  -it -p 2021:22 --name aicex -v `pwd`:/home/aicex/ -i wulffern/aicex:24.04_latest bash --login &

sh26:
	docker run --rm  -it -p 2021:22 --name aicex -v `pwd`:/home/aicex/ -i wulffern/aicex:26.04_latest bash --login &
