...
C {SUN_TR_SKY130NM/SUNTR_NRX1_CV.sym} 400 0 0 0 {name=XXA1}
...
C {SUN_TR_SKY130NM/SUNTR_IVX1_CV.sym} 400 128.0 0 0 {name=XXA2}
N 380.0 128.0 400.0 128.0{lab=YN}
C {devices/lab_pin.sym} 380.0 128.0 0 0  {name=l5 sig_type=std_logic lab=YN }
N 500.0 128.0 480.0 128.0{lab=Y}
C {devices/lab_pin.sym} 500.0 128.0 2 0  {name=l6 sig_type=std_logic lab=Y }
N 460.0 88.0 440.0 88.0{lab=AVDD}
C {devices/lab_pin.sym} 460.0 88.0 2 0  {name=l7 sig_type=std_logic lab=AVDD }
N 460.0 168.0 440.0 168.0{lab=AVSS}
C {devices/lab_pin.sym} 460.0 168.0 2 0  {name=l8 sig_type=std_logic lab=AVSS }
