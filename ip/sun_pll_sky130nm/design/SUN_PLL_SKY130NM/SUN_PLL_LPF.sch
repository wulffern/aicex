...
C {SUN_TR_SKY130NM/SUNTR_RPPO_100k.sym} 0 50 1 0 {name=xa5 xoffset=0 yoffset=5 angle=0 M=1}
...
C {SUN_TR_SKY130NM/SUNTR_RPPO_100k.sym} 0 -70 1 0 {name=xa4 xoffset=0 yoffset=5 angle=0 M=1}
C {devices/lab_pin.sym} 0 30 2 0 {name=l2 sig_type=std_logic lab=VN2
}
C {SUN_TR_SKY130NM/SUNTR_RPPO_100k.sym} 0 -180 1 0 {name=xa3 xoffset=0 yoffset=5 angle=0 M=1}
C {SUN_TR_SKY130NM/SUNTR_RPPO_100k.sym} 0 -290 1 0 {name=xa2 xoffset=0 yoffset=5 angle=0 M=1}
...
C {SUN_TR_SKY130NM/SUNTR_RPPO_100k.sym} 0 -410 1 0 {name=xa1 xoffset=0 yoffset=5 angle=0 M=1}
