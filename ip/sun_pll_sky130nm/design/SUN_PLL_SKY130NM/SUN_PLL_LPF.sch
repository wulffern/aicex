...
C {SUN_PLL_SKY130NM/CAP_LPF.sym} 0 -10 0 0 {name=xb3 xoffset=0 yoffset=0 angle=0 M=5}
C {SUN_PLL_SKY130NM/CAP_LPF.sym} -290 -10 0 0 {name=xb2 xoffset=0 yoffset=0 angle=0 M=1
}
