...
C {devices/lab_pin.sym} 390 -160 0 0 {name=l1 sig_type=std_logic lab=NI
}
C {devices/lab_pin.sym} 170 -310 0 0 {name=l3 sig_type=std_logic lab=AVSS
}
C {devices/ipin.sym} 130 -400 2 1 {name=p4 lab=VDD_1V8
}
C {devices/opin.sym} 850 -160 0 0 {name=p5 lab=CK}
C {devices/lab_pin.sym} 630 -160 1 0 {name=l2 sig_type=std_logic lab=CKUP
}
C {SUN_TR_SKY130NM/SUNTR_NDX1_CV.sym} -400 10 0 0 {name=xb1
}
C {SUN_TR_SKY130NM/SUNTR_IVX1_CV.sym} -10 -10 0 0 {name=xb2[7:0]}
C {SUN_TR_SKY130NM/SUNTR_IVX1_CV.sym} 700 -160 0 0 {name=xa4

}
C {SUN_PLL_SKY130NM/SUN_PLL_LSCORE.sym} 580 -150 0 0 {name=xa3}
C {SUN_TR_SKY130NM/SUNTR_TAPCELLB_CV.sym} 240 -330 0 0 {name=xa5}
C {devices/lab_pin.sym} 390 -140 0 0 {name=l4 sig_type=std_logic lab=N[7]
}
