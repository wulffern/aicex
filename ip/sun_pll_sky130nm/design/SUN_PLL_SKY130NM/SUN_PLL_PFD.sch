...
C {devices/opin.sym} 1120 -680 0 0 {name=p3 lab=CP_UP}
...
C {devices/lab_pin.sym} 820 -680 1 0 {name=l11 sig_type=std_logic lab=CP_UP_N}
...
C {SUN_TR_SKY130NM/SUNTR_TAPCELLB_CV.sym} 1330 -730 0 0 {name=xa0}
C {devices/lab_pin.sym} 1310 -760 0 0 {name=l14 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} 1310 -680 2 0 {name=l15 sig_type=std_logic lab=AVSS}
