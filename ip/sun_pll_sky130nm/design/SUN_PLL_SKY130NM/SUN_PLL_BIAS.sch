...
C {devices/ipin.sym} -490 -300 0 0 {name=p2 lab=AVDD}
C {devices/ipin.sym} -490 -220 0 0 {name=p3 lab=PWRUP_1V8}
...
C {devices/lab_pin.sym} -360 -220 1 0 {name=l1 sig_type=std_logic lab=PWRUP_1V8_N}
C {SUN_TR_SKY130NM/SUNTR_TAPCELLB_CV.sym} -400 -110 0 0 {name=xa0 xoffset=0 yoffset=0 angle=0 M=1}
